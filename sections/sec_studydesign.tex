...
The above string produces 471 references at the time we collected its results (2020-11-12). 
...
%\hline   
%	& \\
%	& i1: Papers which are published from 2017  \\
%	& i2: Papers that are written in English \\
%Inclusion Criteria 	& i3: Peer reviewed papers \\
%	& i4: Study on microservices challenges and adoption \\
%	& i5: Papers which have technology solutions to solve challenges \\
%	& \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{images/exclusion.png}
...
%For these 21 publications, we apply similar procedures for Data Extraction and Synthesis as used for systematic literature review. We amended the spreadsheets with the information obtained from the grey literature. 
